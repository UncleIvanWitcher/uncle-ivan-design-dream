          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 lg:p-12 bg-gradient-to-br from-brand-red to-brand-brick text-white">
              ...
              <a 
                ...
                className="inline-flex items-center text-white hover:text-gray-200 font-bold transition-colors"
              >
        ...
        <div className="mt-16 text-center">
          <div className="flex justify-center items-center mb-6">
            <img 
              ...
              alt="Uncle Ivan Logo" 
              className="w-12 h-12 rounded-full border-2 border-brand-red mr-3" 
            />
