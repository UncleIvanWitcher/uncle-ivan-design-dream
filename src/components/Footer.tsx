  ...
  return <footer id="contact" className="bg-gradient-to-b from-gray-50 to-gray-100 pt-20 pb-10 relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="mt-4">
            <a href="https://www.instagram.com/uncleivaninc/profilecard/?igsh=bDdvb2F5YjB5aTRm" target="_blank" rel="noopener noreferrer" className="text-brand-blue hover:text-brand-indigo transition-colors">
