...
const Header: React.FC = () => {
  return (
    <header className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden pt-20 pb-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="flex-1 text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start mb-6">
              <img 
                src="/lovable-uploads/e5d7aa62-1d7a-4884-86bb-5949adfdc90a.png" 
                alt="Uncle Ivan Logo" 
                className="w-16 h-16 rounded-full border-2 border-brand-red mr-4" 
              />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button 
                className="bg-white border-2 border-brand-red text-brand-red hover:bg-brand-red hover:text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
          ...
          <div className="flex-1 relative">
            ...
            <img 
              ...
              alt="Uncle Ivan" 
              className="rounded-xl shadow-2xl z-10 relative animate-float max-w-full"
            />
          </div>
        </div>
      </div>
